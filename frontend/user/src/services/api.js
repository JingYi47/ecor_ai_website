...
export const authApi = {
  ...
  register: (email, password, firstName, lastName) =>
    request("/user/register", { method: "POST", body: JSON.stringify({ email, password, firstName, lastName }) }),
  ...
  changePassword: (currentPassword, newPassword) =>
    request("/user/change-password", { method: "PUT", body: JSON.stringify({ currentPassword, newPassword }) }),

  forgotPassword: (email) =>
    request("/user/forgot-password", { method: "POST", body: JSON.stringify({ email }) }),
};
...
export const cartApi = {
  ...
  add: (productId, quantity, color) =>
    request("/cart/add", { method: "POST", body: JSON.stringify({ productId, quantity, color }) }),
  updateQuantity: (itemId, quantity) =>
    request(`/cart/quantity/${itemId}`, { method: "PUT", body: JSON.stringify({ quantity }) }),
  toggleSelect: (itemId) =>
...
export const wishlistApi = {
  ...
  add: (productId) =>
    request("/user/wishlist", { method: "POST", body: JSON.stringify({ productId }) }),
  remove: (productId) =>
...
export const couponApi = {
  ...
  apply: (code, subtotal) =>
    request("/coupon/apply", { method: "POST", body: JSON.stringify({ code, subtotal }) }),
};
...
export const paymentApi = {
  ...
  simulateMomo: (checkoutId, success = true) =>
    request("/payment/momo/simulate", { method: "POST", body: JSON.stringify({ checkoutId, success }) }),
};
